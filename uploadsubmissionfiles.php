...
global $connection;
$Query = "INSERT INTO upload(name,format,size) VALUES ('$Name','$File_type','$File_size_in_mb')";
...
<body>
    ...
    <div class="container">
        ...
        <div class="pt-2 submission">
            ...
            <a href="uploadsubmissionfiles.php" class="active px-4"> UPLOAD SUPPLEMENTARY FILES</a>
...
<!--      session code end -->
    <form action="uploadsubmissionfiles.php" method="post" enctype="multipart/form-data">
                ...
                <span><button type="submit" class="btn btn-success" name="submit" value="">Save And Continue</button><a type="button "class="btn btn-outline-success ml-2" name="Cancel" href="uploadsubmissionfiles.php">Cancel</a></span>
            </form>
        </div>
